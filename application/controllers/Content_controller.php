...
class Content_controller extends CI_Controller {
    ...
    public function flights() {
        ...
        $this->load->view('frontend/flights');
    }

    public function car() {
         $sdata['redirect_back'] = 'car';
        $this->session->set_userdata($sdata);
        $this->load->view('frontend/car');
    }

    public function hotels() {
        $sdata['redirect_back'] = 'hotels';
        $this->session->set_userdata($sdata);
        $this->load->view('frontend/hotels');
    }

    public function vacation_rental() {
         $sdata['redirect_back'] = 'vacation-rental';
        $this->session->set_userdata($sdata);
        $this->load->view('frontend/vacation_rental');
    }
    ...
    public function cruise() {
        ...
        $this->session->set_userdata($sdata);
        $this->load->view('frontend/cruise');
    }
    ...
    public function contact_us() {
        $data = array();
        // $data['output_content_user'] = $this->load->view('contact_us', '', true);
    ...
    public function communication_save() {
        ...
        if ($this->Content_model->communication_data_save($data)) {
            ...
            redirect('Content_controller/contact_us', 'refresh');
        } else {
            $sdata = array();
            $sdata['message_save'] = 'not_saved';
            $this->session->set_userdata($sdata);
