...
//        print_r($checkin_details);
    ...
    {
        if(current_url()=='http://rosehotel.homes/index.php/view-check-in-month'||current_url()=='https://rosehotel.homes/index.php/view-check-in-month')
        {
...
//
    ...
    {
        if(current_url()=='http://rosehotel.homes/index.php/view-check-in'||current_url()=='https://rosehotel.homes/index.php/view-check-in')
        {
            $sdata = array(
                'search_hotel_id' => '',
            );
