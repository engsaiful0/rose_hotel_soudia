...
public function country_load(){
    ...
    public function add_check_in_edit_save()
    {
       ...
       // print_r('$image_1='.$image_1);
        if($image_1=='')
        {
            $image_1 = $this->input->get('image_old_1');
        }
        //print_r('image_old_1='.image_old_1);
        //print_r('$image_1='.$image_1);
...
//die;
        ...
        if (!$this->upload->do_upload('image_2')) {
            ...
            $this->upload->do_upload('image_2');
            $sdata = $this->upload->data();
            $image_2 = $sdata['file_name'];
        }
        ...
        if (!$this->upload->do_upload('image_3')) {
            ...
            $this->upload->do_upload('image_3');
            $sdata = $this->upload->data();
            $image_3 = $sdata['file_name'];
        }
        ...
        if (!$this->upload->do_upload('image_4')) {
            ...
            $this->upload->do_upload('image_4');
            $sdata = $this->upload->data();
            $image_4 = $sdata['file_name'];
        }
        ...
        if (!$this->upload->do_upload('image_5')) {
            ...
            $this->upload->do_upload('image_5');
            $sdata = $this->upload->data();
            $image_5 = $sdata['file_name'];
        }
        ...
        if (!$this->upload->do_upload('image_6')) {
            ...
            $this->upload->do_upload('image_6');
            $sdata = $this->upload->data();
            $image_6 = $sdata['file_name'];
        }
        ...
        if (!$this->upload->do_upload('image_7')) {
            ...
            $this->upload->do_upload('image_7');
            $sdata = $this->upload->data();
            $image_7 = $sdata['file_name'];
        }
        ...
        if (!$this->upload->do_upload('image_8')) {
            ...
            $this->upload->do_upload('image_8');
            $sdata = $this->upload->data();
            $image_8 = $sdata['file_name'];
        }
        ...
        if (!$this->upload->do_upload('image_9')) {
            ...
            $this->upload->do_upload('image_9');
            $sdata = $this->upload->data();
            $image_9 = $sdata['file_name'];
        }
        ...
        if (!$this->upload->do_upload('image_10')) {
            ...
            $this->upload->do_upload('image_10');
            $sdata = $this->upload->data();
            $image_10 = $sdata['file_name'];
        }
...
//        die;
    ...
    public function view_check_in_month()
    {
        ...
        $this->db->order_by('checkin_details.checkin_id', 'desc');
        $query = $this->db->get("checkin_details");

        $config['total_rows'] = $this->db->count_all('checkin');
        $config['per_page'] = 100;
...
//
    ...
    public function view_check_in_day()
    {
        ...
        $this->db->join('checkin_details', 'checkin.checkin_id  = checkin_details.checkin_id');
        $this->db->order_by('checkin_details.checkin_id', 'desc');


        $config['base_url'] = site_url('CheckinController/view_check_in_day');
        $config['total_rows'] = $this->db->count_all('checkin_details');
        $config['per_page'] = 100;
        $config["uri_segment"] = 3;
        $choice = $config["total_rows"] / $config["per_page"];
        $config["num_links"] = floor($choice);
