            ...
            <table id="financial_cost_table" border="1" class="financial_cost_table" style="width: 700px!important;margin: 0 auto;color:black;border-collapse:collapse;">
                ...
                ?>
                    <tr style="background-color:#1E3D73;color:white">
                        <td colspan="8" style="text-align: center">Transaction Report for <b><?php echo $hotel->hotel_name_in_english ?> and <?php echo dateRangeToText($from_date, $to_date) ?></b> </td>
                    </tr>
                <?php
                } else if ($from_date != '' and $to_date == '' and $hotel_id == '') {
                ?>
                    <tr style="background-color:#1E3D73;color:white">
                        <td colspan="8" style="text-align: center">Transaction Report of date <b><?php echo date('d-m-Y', strtotime($from_date)); ?></b></td>
                    </tr>
                <?php
                } else if ($from_date == '' and $to_date != '' and $hotel_id == '') {
                ?>
                    <tr style="background-color:#1E3D73;color:white">
                        <td colspan="8" style="text-align: center">Transaction Report of date <b><?php echo date('d-m-Y', strtotime($to_date)); ?></b></td>
                    </tr>
                <?php
                } else if ($from_date == '' and $to_date == '' and $hotel_id != '') {
                    $hotel = $this->db->select('*')
                ...
                ?>
                    <tr style="background-color:#1E3D73;color:white">
                        <td colspan="8" style="text-align: center">Transaction Report for <b><?php echo $hotel->hotel_name_in_english ?></b></td>
                    </tr>
                <?php
                } else if ($from_date == '' and $to_date == '' and $hotel_id == '') {
                ?>
                    <tr style="background-color:#1E3D73;color:white">
                        <td colspan="8" style="text-align: center">Transaction Report</td>
                    </tr>
                <?php
                }
                ?>
                ...
                <tr>
                    <td></td>
                    <td colspan="" style="text-align: right;font-weight: bold">Total Income</td>
                    <td colspan="6" style="font-weight: bold"><?php echo number_format(($grand_total_total_amount), 0) ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="" style="text-align: right;font-weight: bold">Total Expense</td>
                    <td colspan="6" style="font-weight: bold"><?php echo number_format(($grand_total_total_expense), 0) ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="" style="text-align: right;font-weight: bold">Total Balance</td>
