        ...
        <page size="A4">
                    ...
                    <table  id="financial_cost_table" border="1" class="financial_cost_table" style="width: 100%!important;margin: 0 auto;color:black;border-collapse:collapse;position: absolute">
                        <tr>
                            ...
                            <td colspan="7" style="text-align: center">Checkin Report</td>
                        </tr>
                        <tr>
                            <td>Sl</td>
                        ...
                        if ($hotel_id!='null') {
                            ...
                            $this->db
                                ...
                                ->where('checkin_details.data_insert_time>=', date('Y-m-d', strtotime($from_date)))
                                ->where('checkin_details.data_insert_time<=', date('Y-m-d', strtotime($to_date)));
...
//                            $this->db->limit(45, $from);
                        ...
                        foreach ($query as $query_value) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo date('d-m-Y',strtotime($query_value->dateOfExit)) ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php echo $query_value->insurance ?>
                                </td>
