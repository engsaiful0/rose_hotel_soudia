            ...
            <form>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input onclick="expense_report_load()" style="color: white" type="button" class="form-control bg-primary" id="submit_button" value="Submit">
                    </div>
                </div>
            </form>
        </div>
        <div id="expense_report_load">
    ...
    function expense_report_load()
    {
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                ...
                document.getElementById("expense_report_load").innerHTML = xhttp.responseText;

            }
        }
        //                    alert(xhttp.responseText);
        xhttp.open("POST", "<?php echo site_url('ReportController/expense_report_load'); ?>", true);
