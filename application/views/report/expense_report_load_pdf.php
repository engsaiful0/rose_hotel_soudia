        ...
        <div class="second">
           ...
           // include 'report_header_pdf.php';
            ...
            <?php
                        ...
                        ?>
                            <tr>
                                <td colspan="4" style="text-align: center">Expense Report From date <b><?php echo date('d-m-Y', strtotime($from_date)); ?></b> To date <b><?php echo date('d-m-Y', strtotime($to_date)); ?></b></td>
                            </tr>
                        <?php
                        } else if ($from_date != '' and $to_date == '') {
                            ?>
                            <tr>
                                <td colspan="4" style="text-align: center">Expense Report of date <b><?php echo date('d-m-Y', strtotime($from_date)); ?></b></td>
                            </tr>
                        <?php
                        } else if ($from_date == '' and $to_date != '') {
                            ?>
                            <tr>
                                <td colspan="4" style="text-align: center">Expense Report of date <b><?php echo date('d-m-Y', strtotime($to_date)); ?></b></td>
                            </tr>
                        <?php
                        } else {
                            ?>
                            <tr>
                                <td colspan="4" style="text-align: center">Expense Report</td>
                            </tr>
                        <?php
                        }
                        ?>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            $grand_total_expense += $query_value->amount;
                            ?>
                        </td>
                        <td>
                ...
                <tr>
                    ...
                    <td style="font-weight: bold"><?php echo number_format($grand_total_expense, 0) ?></td>
                    <td></td>
