...
<div id="report">
    ...
    <table id="financial_cost_table" border="1" class="financial_cost_table" style="width: 100%;!important;margin: 0 auto;color:black;border-collapse:collapse;">
        ...
        for($i=$from_day;$i<=$to_day;$i++)
        {
            ...
            $this->db->select_sum('rent', 'amount')
                ->where('checkin_details.hotel_id', $hotel_id)
                ->where('dateOfEntry', $new_date);
            ...
            <tr>
                ...
                <td>
                    ...
                    $grand_total_rent += $query_total[0]->amount;
                    ?>
                </td>
                <td>
        ...
        <tr>
            ...
            <td style="font-weight: bold"><?php echo number_format($grand_total_rent, 0) ?></td>
            <td></td>
        </tr>
    </table>
</div>
