            ...
            <form>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input onclick="checkinmonth_report_load()" style="color: white" type="button"
                               class="form-control bg-primary" id="submit_button" value="Submit">
                    </div>
                </div>
            </form>
        </div>
        <div id="checkinmonth_report_load">
...
<script>
    function checkinmonth_report_load() {
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                ...
                document.getElementById("checkinmonth_report_load").innerHTML = xhttp.responseText;

            }
        }
        //                    alert(xhttp.responseText);
        xhttp.open("POST", "<?php echo site_url('ReportController/checkinmonth_report_load'); ?>", true);
