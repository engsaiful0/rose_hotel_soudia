    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <?php
                $sl = 1;
                $rooms = $this->db->where('status', 'booked')->where('day_or_month', 'day')->where('hotel_id', $hotel->hotel_id)->order_by('room_no_in_english','ASC')->get('room')->result();
                foreach ($rooms as $room) {
                    ...
                    <div class="container-room" data-toggle="modal"
                         ...
                         style="background-image: url('<?php base_url()?>assets/room_container.jpg');background-repeat: no-repeat;float: left;width: 108px;height: 200px;  ">
                        ...
                        <div style="padding-top: 24px">
                            <p style="color: red;text-align: center;font-weight: bold;font-size: 15px;"><?php
                                if ($language == 'english') {
                                    echo $room->price;
                                } else {
