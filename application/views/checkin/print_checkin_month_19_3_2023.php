    ...
    <table border="1"
        ...
        <tr>
            <td colspan="7" style="text-align: right">
                نعم أنا المستأجر اسمي أعلاه قد استلمت الشقة بمحتوياتها كاملة وأن أي تلف أو فقدان من محتويات الشقة
                حسب دفتر الأغراض فإني مسئول مسئولية كاملة عن دفع القيمة كاملة حسب تقييم المكتب .
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: right">
                على الخروج قبل إنتهاء المدة المحددة وعند التأخير يحسب على ٢٤ ساعة بقيمتها علما بأن موعد التسليم
                الثانية ظهرا
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: right">
                وعند خروجي قبل إنتهاء المدة المحددة فليس لدي الحق نے مطالبة باقي نقودي لأي سبب كان وعلى ذلك أوقع .
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: right">
                يلزم الضيف بأنظمة وقوانين المملكة ويحترم عادات وتقاليد البلاد وعند مخالفته لذلك يعتبر العقد لاغي
                ويتم إخلاء الشقة فورا دون المطالبة بأي حق
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: right">
                يلتزم المستأجر بالمحافظة على نظافة الشقة وتسليمها نظيفة كما استلمها وإلا يخصم مقابل ذلك
        ...
        <tr>
            <td colspan="7" style="text-align: right">
                في حالة العثور على بقع حريق نتيجة الإستعمال المكواة أو السجائر أو أي حروق أخرى فسوف يتحمل الضيف قيمة
                استبدال الموكيت التالف .
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: right">
                الإدارة غير مسؤولة عن أي أشياء ثمينة مثل المجوهرات وخلافه في حالة فقدانها ولا يجوز تركها داخل الشقة
                لأي طرف .
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: right">
                أقر بمسئوليتي الكاملة عن ما معي من مرافقين وزوار وعن تصرفاتهم كاملة.
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: right">
                يتوجب على المستأجر عند التجديد لتسديد قيمة الإيجار كاملة وإلا يعتبر العقد منتهي ويجب إخلاء الشقة
                فورا قرأت الشروط كاملة وعلمت بما فيها وأقربالإلتزام بكل بنود العقد وعلى ذلك أوقع .
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: right">
                ۱في حالة إلغاء العقد الشهري يحسب بالإيجار اليومي .
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: right">
                في حالة فقدان الكرت يتم دفع ۱۰۰ ریال غرامة .
            </td>
        </tr>
        <tr>
            <td colspan="7" style="text-align: right">
                ۱في حالة التأخير عن موعد المغادرة يتم احتساب ۲۰ ريال عن كل ساعة تأخير ،
            </td>
        </tr>
    ...
    <table border="1" style="border-collapse: collapse;width: 97%;margin: 0 auto;margin-top: 5px;">
        <tr>
            <td colspan="2" class="td_color" colspan="2"
                style="text-align: center;background-color: #0a568d;color: white">
                <?php
                if ($language == 'english') {
                    ?>
                    Customer signature
