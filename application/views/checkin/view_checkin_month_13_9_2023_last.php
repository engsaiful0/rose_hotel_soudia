        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <form method="post" action="<?php echo base_url() ?>view-check-in-month">
                        <table class="table table-bordered table-hover table-condensed table-responsive"
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo base_url() ?>assets/ajax-loader.gif" id="img_loader"
...
//                            print_r($result);
                            ...
                            <tr>
                                ...
                                //                                print_r('$data='.$data);
                                //                                print_r('$checkin_detail->dateOfExit='.$checkin_detail->dateOfExit.'<br>');
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="<?php echo base_url() ?>exit-month-save">
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Do you want to renew?')" title="Details"
                                       ...
                                       href="<?php echo base_url() ?>start-renew-month/<?php echo $checkin_details_id ?>"><?php
                                        if ($language == 'english') {
                                            ?>
                                            Renew
                                            <?php
                                ...
                                if ($user_type == 'superadmin') {
                                    ...
                                    <td>
                                        <a title="Edit" class="btn btn-primary"
                                           href="<?php echo base_url() ?>checkin-edit-month/<?php echo $checkin_id ?>"><i
                                                    class="fa fa-pen "></i></a>
                                    </td>
