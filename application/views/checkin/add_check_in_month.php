                            ...
                            <div class="form-row">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <?php
                                        $save_btn_label_month = ($language == 'english') ? 'Save' : 'يحفظ';
                                        $save_btn_saving_month = ($language == 'english') ? 'Saving...' : 'جارٍ الحفظ...';
                                        ?>
                                        <button id="submit_button_month" type="submit" class="btn btn-primary d-inline-flex align-items-center" data-saving-text="<?php echo htmlspecialchars($save_btn_saving_month, ENT_QUOTES, 'UTF-8'); ?>" aria-live="polite">
                                            <span id="submit_button_month_spinner" class="spinner-border spinner-border-sm align-middle d-none mr-1" role="status" style="min-width:1em;min-height:1em" aria-hidden="true"></span>
                                            <span id="submit_button_month_text"><?php echo $save_btn_label_month; ?></span>
                                        </button>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    (function() {
        var form = document.getElementById('checkinFormMonth');
        if (!form) { return; }
        var submitBtn = document.getElementById('submit_button_month');
        var spinner = document.getElementById('submit_button_month_spinner');
        var textEl = document.getElementById('submit_button_month_text');
