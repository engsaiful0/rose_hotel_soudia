                    ...
                    <form method="post" action="<?php echo base_url() ?>view-check-in">
                        <table class="table table-bordered table-hover table-condensed table-responsive" style="width: 90%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select onchange="room_load(this.value)" id="hotel_id" name="hotel_id" class="form-control">
                                ...
                                ?>
                                <td><input type="submit" id="sumbit_button" value="<?php echo $search ?>" class="btn btn-primary"></td>
                                <td>
                                    <img src="<?php echo base_url() ?>assets/ajax-loader.gif" id="img_loader" style="display:none;position:fixed;z-index:1" />
                                </td>
                            </tr>
                        </table>
                    </form>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    if (($data == $result[$i]->dateOfExit && $time >= 15 && $min > 0 && $result[$i]->exit_status == 'no') || ($data > $result[$i]->dateOfExit  && $result[$i]->exit_status == 'no')) {
                                        $data = array(
                                            'exit_status' => 'yes'
                                        );
                                        $data_room = array(
                                    ...
                                    ?>
                                        <td style="background-color: red;color: white"><?php echo date('d-m-Y', strtotime($result[$i]->dateOfExit)) ?>
                                            ...
                                            <a title="Details" class="btn btn-primary" data-toggle="modal" data-target="#exitModal<?php echo $checkin_details_id ?>" href="#">
                                                <?php
                                                if ($language == 'english') {
                                                    echo 'Exit';
                                                } else {
                                    ...
                                    ?>
                                    <div class="modal fade" id="exitModal<?php echo $checkin_details_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="<?php echo base_url() ?>exit-save">
                                                        ...
                                                        <input name="checkin_details_id" class="form-control" type="hidden" value="<?php echo $checkin_details_id ?>">
                                                        <input name="room_id" class="form-control" type="hidden" value="<?php echo $room_id ?>">
                                    ...
                                    <td>
                                        <!-- Modal -->
                                        <div class="modal fade" id="exampleModal<?php echo $checkin_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document" style="max-width: 1100px!important;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        ?>
                                                        <table class="table table-hover table-bordered table-striped" border="1" style="border-collapse: collapse;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php
                                                                    $timestamp = $checkin->data_insert_time;
                                                                    
                                                                    $formatted_date =  date('d-m-Y', strtotime($checkin->entry_date)).' '.$checkin->entry_time;
                                                                    echo $formatted_date;
                                                                    ?></td>
                                                                <td ></td>
                                                                <td></td>
                                                        ...
                                                        <table class="table table-hover table-bordered table-striped" border="1" style="border-collapse: collapse;">
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        <td colspan="7">
                                                                            <img style="width: 100%;" src="<?php echo base_url() ?>assets/images/<?php echo $checkin_detail->image ?>">
                                                                        </td>
                                                                    </tr>
                                                                <?php
                                                                }
                                        ...
                                        <a title="Details" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo $checkin_id ?>" href="#"><i class="fa fa-clock "></i></a>
                                    </td>
                                    <?php
                                    $user_type = $this->session->userdata('type');
                                    if ($user_type == 'superadmin') { ?>
                                        <td>
                                            <a title="Edit" class="btn btn-primary" href="<?php echo base_url() ?>checkin-edit/<?php echo $checkin_id ?>"><i class="fa fa-pen "></i></a>
                                        </td>

                                        <td>
                                            <a onclick="return confirm('Do you want to delete this head?')" title="Delete" class="btn btn-danger" href="<?php echo base_url() ?>checkin-delete/<?php echo $checkin_id ?>"><i class="fa fa-trash "></i></a>
                                        </td>
                                    <?php
                                    }
                                    ?>
