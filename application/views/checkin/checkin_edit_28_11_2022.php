                        ...
                        <div class="col-md-6">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input value="<?php echo $checkin->guest_unique_id?>"  type="text" class="form-control" name="guest_unique_id"
                                           id="guest_unique_id"  />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                        ...
                                        ?></label>
                                    <input class="form-control date_of_birth" required name="date_of_birth" value="<?php echo date('d-m-Y',strtotime($checkin->date_of_birth))?>"
                                           id="datepicker"
                                        ...
                                        <table id="product_table"
                                            ...
                                            foreach ($checkin_details as $checkin_detail)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input  class="form-control" type="text" name="image_old_1" value="<?php echo $checkin_detail->image?>"
                                                                id="image_old_1">
                                                        <input class="form-control" type="file" name="image_1"
                                                               id="image_1">
                                                    </td>
                                                    <td style="display: none">
                                                        <input class="form-control" name="account_number[]" value="<?php echo $checkin_detail->account_number?>"
                                                               id="account_number_1">
                                                    </td>
                                                    <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="file" name="image_3"
                                                           id="image_3">
                                                    <input class="form-control" value="<?php echo $due?>" type="hidden" name="image_3_old"
                                                           id="image_3">
                                                </td>
                                                <td style="display: none">
                                                    <input class="form-control" name="account_number[]"
