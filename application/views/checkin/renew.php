<script>
    // function grandRentCalculate() {
    //     alert();
    //     //var grand_rent = 0;
    //     // //for (var i = 1; i <= 20; i++) {
    //     //     //var rent = Number(document.getElementById('rent_' + i).value);
    //     //     //grand_rent += rent;
    //     //     //alert(grand_rent);
    //     // //}
    //     // //$('#grandRent').val(grand_rent);
    //     // alert(grand_rent);
    //     // document.getElementById('grandRent').value=grand_rent;
    // }
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <form method="get" enctype="multipart/form-data"
              action="<?php echo base_url() ?>renew-save">
                        ...
                        <div class="col-md-6">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input readonly class="form-control" required name="guest_name"
                                    ...
                                    <select  class="form-control" required name="country_id"
                                        ...
                                        foreach ($countries as $countrie) {
                                            ...
                                            <option <?php echo $selected ?>
                                                    value="<?php echo $countrie->country_id ?>"><?php
                                                if ($language == 'english') {
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                        ...
                                        ?></label>
                                    <input readonly value="<?php echo $checkin->place ?>" class="form-control" required
                                           name="place"
                                           id="place"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                        ...
                                        ?></label>
                                    <input readonly class="form-control" required name="date_of_birth"
                                           value="<?php echo date('d-m-Y', strtotime($checkin->date_of_birth)) ?>"
                                           id="datepicker"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                        ...
                                        ?></label>
                                    <input readonly class="form-control" required name="mobile"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                        ...
                                        ?></label>
                                    <input readonly class="form-control" required name="profession_id"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                        ...
                                        ?></label>
                                    <input type="text" readonly placeholder="<?php echo $subtotal_placeholder ?>"
                                           class="form-control" value="<?php echo $checkin->grandRent ?>"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <table id="product_table"
                                            ...
                                            <tr>
                                                <td>
                                                    <select  style="width: 150px" required class="form-control"
                                                             name="day_or_month_or_year"
                                                ...
                                                <td>
                                                    <input class="form-control" required name="dateOfEntry"
                                                ...
                                                <td>
                                                    <input class="form-control" required name="dateOfExit"
                                                           id="dateOfExit_1"
                                                           value="<?php echo date('d-m-Y', strtotime($checkin_details->dateOfExit)) ?>"
                                                           placeholder="<?php echo $dateOfExitPlaceHolder ?>">
                                                </td>
                                                <td>
                                                    <input oninput="subTotalCalculate()"
                                                           value="<?php echo $checkin_details->rent ?>"
                                                ...
                                                <td>
                                                    <select class="form-control" name="cash_or_credit"
                                                            id="cash_or_credit_1">
                                                ...
                                                <td>
                                                    <input class="form-control" name="insurance"
                                                           value="<?php echo $checkin_details->insurance ?>"
                                                           id="insurance_1">
                                                </td>
                                                <td></td>
                                            </tr>
                            ...
                            <div class="form-row">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <button id="renewSaveButton" onclick="buttonDisable()" type="submit" class="btn btn-primary">
                                            Renew Save
    ...
    <script>
        ...
        {
            document.getElementById('renewSaveButton').style.display='none';
            $('#img').show();
        }
    </script>
