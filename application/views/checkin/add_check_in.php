                        ...
                        <div class="col-md-6">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input class="form-control" required name="guest_name" id="guest_name" placeholder="<?php echo $placeholder_guest_name ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input onchange="infoLoad(this.value)" type="text" class="form-control" name="guest_unique_id" id="guest_unique_id" list="guest_unique_ids" />
                        ...
                        <div class="col-md-6">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="form-control" required name="country_id" id="country_id_all">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                                                ...
                                                                ?></label>
                                    <input class="form-control" required name="place" id="place" placeholder="<?php echo $placeholder_place ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                                                ...
                                                                ?></label>
                                    <input class="form-control date_of_birth" required name="date_of_birth" value="<?php echo date('d-m-Y') ?>" id="datepicker" placeholder="<?php echo $dateOfBirthPlaceHolder ?>">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                                                ...
                                                                ?></label>
                                    <input class="form-control" required name="mobile" id="mobile" placeholder="<?php echo $mobilePlaceholder ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                                                ...
                                                                ?></label>
                                    <input class="form-control" required name="profession_id" id="profession_id" placeholder="<?php echo $profession_id_placeholder ?>">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4"><?php
                                                                ...
                                                                ?></label>
                                    <input readonly placeholder="<?php echo $subtotal_placeholder ?>" class="form-control" required name="grandRent" id="grandRent">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <table id="product_table" class="table table-bordered table-striped table-hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <select style="width: 150px" required class="form-control" name="day_or_month_or_year[]" id="day_or_month_or_year_1">
                                                        <?php
                                                ...
                                                <td>
                                                    <select style="width: 150px" required class="form-control" name="room_id[]" id="roomnumberid_1">
                                                        <option></option>
                                                        <?php
                                                ...
                                                <td>
                                                    <input class="form-control" required name="dateOfEntry[]" value="<?php echo date('d-m-Y') ?>" id="dateOfEntry_1" placeholder="<?php echo $dateOfEntryPlaceHolder ?>">
                                                </td>
                                                <td>
                                                    <input class="form-control" required name="dateOfExit[]" value="<?php echo date('d-m-Y') ?>" id="dateOfExit_1" placeholder="<?php echo $dateOfExitPlaceHolder ?>">
                                                </td>
                                                <td>
                                                    <input oninput="subTotalCalculate()" onkeypress="return isNumberKey(this, event);" class="form-control" required name="rent[]" id="rent_1">
                                                </td>
                                                <td style="display: none">
                                                    <input oninput="due_cal(this.id)" placeholder="<?php echo $paid ?>" class="form-control" name="paid[]" id="paid_1">
                                                </td>
                                                <td>
                                                    <input placeholder="<?php echo $due ?>" class="form-control" name="due[]" id="due_1">
                                                </td>
                                                ...
                                                <td style="display: none">
                                                    <input class="form-control" name="account_number[]" id="account_number_1">
                                                </td>
                                                <td>
                                                    <input class="form-control" name="insurance[]" id="insurance_1">
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr style="display: none">
                                                <td>
                                                    <select style="width: 150px" class="form-control" name="day_or_month_or_year[]" id="day_or_month_or_year_2">
                                                        <?php
                                                ...
                                                <td>
                                                    <select style="width: 150px" class="form-control" name="room_number_id[]" id="roomnumberid_2">
                                                        <option></option>
                                                        <?php
                                                        $rooms = $this->db->where('hotel_id', $hotel_id)->where('status', 'Free')->order_by('room_no_in_english', 'asc')->get('room')->result();
                                                        foreach ($rooms as $room) {
                                                ...
                                                <td>
                                                    <input class="form-control" name="dateOfEntry[]" value="<?php echo date('d-m-Y') ?>" id="dateOfEntry_2" placeholder="<?php echo $dateOfEntryPlaceHolder ?>">
                                                </td>
                                                <td>
                                                    <input class="form-control" required name="dateOfExit[]" value="<?php echo date('d-m-Y') ?>" id="dateOfExit_2" placeholder="<?php echo $dateOfExitPlaceHolder ?>">
                                                </td>
                                                <td>
                                                    <input onkeypress="return isNumberKey(this, event);" class="form-control" oninput="subTotalCalculate()" name="rent[]" id="rent_2">
                                                </td>
                                                <td style="display: none">
                                                    <input oninput="due_cal(this.id)" placeholder="<?php echo $paid ?>" class="form-control" name="paid[]" id="paid_2">
                                                </td>
                                                <td>
                                                    <input placeholder="<?php echo $due ?>" class="form-control" name="due[]" id="due_2">
                                                </td>
                                                ...
                                                <td style="display: none">
                                                    <input class="form-control" name="account_number[]" id="account_number_2">
                                                </td>
                                                <td>
                                                    <input class="form-control" name="insurance[]" id="insurance_2">
                                                </td>
                                                <td></td>
                                            </tr>
                                            ...
                                            <tr style="display: none">
                                                <td>
                                                    <select style="width: 150px" class="form-control" name="day_or_month_or_year[]" id="day_or_month_or_year_3">
                                                        <?php
                                                        include 'day_or_month_or_year.php';
                                                        ?>
                                                    </select>
                                                ...
                                                <td>
                                                    <select style="width: 150px" class="form-control" name="room_id[]" id="roomnumberid_3">
                                                        <option></option>
                                                        <?php
                                                        $rooms = $this->db->where('hotel_id', $hotel_id)->where('status', 'Free')->order_by('room_no_in_english', 'asc')->get('room')->result();
                                                        foreach ($rooms as $room) {
                                                ...
                                                <td>
                                                    <input class="form-control" name="dateOfEntry[]" value="<?php echo date('d-m-Y') ?>" id="dateOfEntry_3" placeholder="<?php echo $dateOfEntryPlaceHolder ?>">
                                                </td>
                                                <td>
                                                    <input class="form-control" name="dateOfExit[]" value="<?php echo date('d-m-Y') ?>" id="dateOfExit_3" placeholder="<?php echo $dateOfExitPlaceHolder ?>">
                                                </td>
                                                <td>
                                                    <input onkeypress="return isNumberKey(this, event);" class="form-control" oninput="subTotalCalculate()" name="rent[]" id="rent_3">
                                                </td>
                                                <td style="display: none">
                                                    <input oninput="due_cal(this.id)" placeholder="<?php echo $paid ?>" class="form-control" name="paid[]" id="paid_3">
                                                </td>
                                                <td>
                                                    <input placeholder="<?php echo $due ?>" class="form-control" name="due[]" id="due_3">
                                                </td>
                                                ...
                                                <td style="display: none">
                                                    <input class="form-control" name="account_number[]" id="account_number_3">
                                                </td>
                                                <td>
                                                    <input class="form-control" name="insurance[]" id="insurance_3">
                                                </td>
                                                <input type="hidden" id="idControl" value="3">
                                                <input type="hidden" id="current_id" value="3">
                                                <td><input style="width: 100%!important;color:black" type="button" onclick="load_product_row()" readonly id="add_more" title="Click To Add" value="+"></td>
                                            </tr>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="inputEmail4"><?php
                                                                    ...
                                                                    ?></label>
                                        <input required class="form-control" value="<?php echo date("h:i a") ?>" required name="entry_time" id="entry_time" type="text" placeholder="<?php echo $entry_time ?>">
                                    </div>
                                </div>
                            </div>
                            <script>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="inputEmail4"><?php
                                                                    ...
                                                                    ?></label>
                                        <input value="<?php echo date('Y-m-d') ?>" placeholder="<?php echo $entry_date_placeholder ?>" class="form-control" required name="entry_date" id="entry_date">
                                    </div>
                                </div>
                            </div>
                        </div>
