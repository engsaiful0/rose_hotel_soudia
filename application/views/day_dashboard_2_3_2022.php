    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <?php
                $sl = 1;
                $rooms = $this->db->where('status', 'booked')->where('day_or_month', 'day')->where('hotel_id', $hotel->hotel_id)->get('room')->result();
                foreach ($rooms as $room) {
                    $checkin_details_id_for_renew = 0;
                    ?>
                    <div class="container-room"
                         style="width: 10%;float: left;margin-right: 5px;padding-top: 10px;background-color: #0f9d58;margin-top: 5px;  ">
                        <div>
