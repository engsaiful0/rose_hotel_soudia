...
$route['transaction-save'] = 'TransactionController/transaction_save';
$route['view-transaction'] = 'TransactionController/view_transaction';
$route['transaction-delete/(:any)'] = 'TransactionController/transaction_delete/$1';
$route['transaction-edit/(:any)'] = 'TransactionController/transaction_edit/$1';
$route['transaction-edit-save'] = 'TransactionController/transaction_edit_save';

$route['add-expense'] = 'ExpenseController/add_expense';
$route['expense-save'] = 'ExpenseController/expense_save';
$route['view-expense'] = 'ExpenseController/view_expense';

$route['expense-delete/(:any)'] = 'ExpenseController/expense_delete/$1';
$route['expense-edit/(:any)'] = 'ExpenseController/expense_edit/$1';
$route['expense-edit-save'] = 'ExpenseController/expense_edit_save';
...
$route['income-report'] = 'ReportController/income_report';
$route['expense-report'] = 'ReportController/expense_report';
$route['transaction-report'] = 'ReportController/transaction_report';
...
$route['expense-search'] = 'Examples/add_expense';
...
$route['file_upload'] = 'CheckinController/file_upload';
$route['view_check_in_day_ajax'] = 'CheckinController/view_check_in_day_ajax';
$route['view_checkin_month_ajax'] = 'CheckinController/view_checkin_month_ajax';
...
$route['print-text'] = 'Examples/print_text';
