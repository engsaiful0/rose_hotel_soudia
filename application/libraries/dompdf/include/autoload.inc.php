...
// Legacy __autoload() branch removed: PHP 8+ rejects parsing `function __autoload`
// even when unreachable. SPL autoload (block above) is always used on supported PHP.
